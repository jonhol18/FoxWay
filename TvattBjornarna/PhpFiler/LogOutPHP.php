    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif|Raleway" rel="stylesheet">
            <ul class="meny" style="margin-left: 150px; margin-right: 150px; margin-top: 0px;">
                ...
                <li style="float: right; position: relative;"><a href="LogInPHP.php">LOGGA IN</a></li>
        
        </ul>
    <div style="margin-left: 150px; margin-right: 150px;"class="bakgrund">
                <br><br>
            <h2  style="float; text-align:center; color:rgb(141, 157, 187); padding-right:30px;">Du är nu utloggad!</h2>
            <br><br>  
    </head>
<body>
<div class="footer2">
