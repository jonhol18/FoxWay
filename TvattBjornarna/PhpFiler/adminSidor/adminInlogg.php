...
<ul class="meny" style="margin-left: 150px; margin-right: 150px; margin-top: 0px;">
                ...
                <li style="float: right; position: relative;"><a href="adminInlogg.php">LOGGA IN</a></li>
                <li style="float: right; position: relative;"><a href="../LogInPHP.php">LOGGA IN SOM ANVÄNDARE</a></li>
